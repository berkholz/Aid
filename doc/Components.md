The Automated internet downloader(Aid) consists of diverse independent components, that each has its own aspect of Aid.
...
The following diagram describes each component in a brief manner:
