...
sudo yum update
sudo yum install -y postgresql-contrib postgresql-server postgresql
...
#sudo -u postgres psql -c "DROP DATABASE IF EXISTS postgres;" > /dev/null 2>&1
...
#sudo -u postgres psql -c "GRANT CONNECT ON DATABASE postgres TO python_client;" > /dev/null
...
#sudo -u postgres psql -c "GRANT CONNECT ON DATABASE postgres TO spring_client;" > /dev/null
...
sudo -u postgres psql -d postgres -c "INSERT INTO config (app_name, activated) VALUES ('adobe', TRUE);" > /dev/null
sudo -u postgres psql -d postgres -c "INSERT INTO config (app_name, activated) VALUES ('adobe_enterprise', TRUE);" > /dev/null
sudo -u postgres psql -d postgres -c "INSERT INTO config (app_name, activated) VALUES ('firefox_esr', TRUE);" > /dev/null
sudo -u postgres psql -d postgres -c "INSERT INTO config (app_name, activated) VALUES ('gimp', TRUE);" > /dev/null
sudo -u postgres psql -d postgres -c "INSERT INTO config (app_name, activated) VALUES ('inkscape', TRUE);" > /dev/null
sudo -u postgres psql -d postgres -c "INSERT INTO config (app_name, activated) VALUES ('keepass', TRUE);" > /dev/null
sudo -u postgres psql -d postgres -c "INSERT INTO config (app_name, activated) VALUES ('ms_powerbi_desktop', TRUE);" > /dev/null
sudo -u postgres psql -d postgres -c "INSERT INTO config (app_name, activated) VALUES ('ms_powerbi_report_server', TRUE);" > /dev/null
sudo -u postgres psql -d postgres -c "INSERT INTO config (app_name, activated) VALUES ('notepadpp', TRUE);" > /dev/null
sudo -u postgres psql -d postgres -c "INSERT INTO config (app_name, activated) VALUES ('putty', TRUE);" > /dev/null
sudo -u postgres psql -d postgres -c "INSERT INTO config (app_name, activated) VALUES ('sqldeveloper', TRUE);" > /dev/null
sudo -u postgres psql -d postgres -c "INSERT INTO config (app_name, activated) VALUES ('sqlitebrowser', TRUE);" > /dev/null
sudo -u postgres psql -d postgres -c "INSERT INTO config (app_name, activated) VALUES ('stunnel', TRUE);" > /dev/null
sudo -u postgres psql -d postgres -c "INSERT INTO config (app_name, activated) VALUES ('sysinternal_utilities', TRUE);" > /dev/null
sudo -u postgres psql -d postgres -c "INSERT INTO config (app_name, activated) VALUES ('winscp', TRUE);" > /dev/null

sudo -u postgres psql -d postgres -c "GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE config TO spring_client;" > /dev/null
sudo -u postgres psql -d postgres -c "GRANT SELECT ON TABLE config TO python_client;" > /dev/null
